                ...
                <tr>
                    ...
                    <td>
                        ...
                        switch ($log->status) {
                            case 'posted':
                            case 'success':
                                $status_class = 'fb-log-success';
                                $status_text = __('Succes', 'fb-post-scheduler');
                                break;
                            case 'error':
                                $status_class = 'fb-log-error';
                                $status_text = __('Fejl', 'fb-post-scheduler');
                                break;
                            case 'info':
                                $status_class = 'fb-log-info';
                                $status_text = __('Info', 'fb-post-scheduler');
                                break;
                            default:
                                $status_class = 'fb-log-default';
